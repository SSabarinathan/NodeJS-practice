...
import { EOL, cpus, arch, constants, endianness as _endianness, freemem, getPriority, homedir, hostname, loadavg, machine, networkInterfaces, platform, release, tmpdir, totalmem } from 'os';
const text= 'Hi' + EOL + 'Node Js';
console.log(text);
...
console.log('Load Average of system is : ', loadavg());
...
console.log('Machine type is : ', machine());
...
console.log('Network Interface for the current machine is  :' , networkInterfaces());
...
console.log('Your platform name is : ',platform());
...
console.log('Information of the computer on which Node.js is currently running on : ',release());
...
console.log('default directory for temporary file name is : ', tmpdir());
